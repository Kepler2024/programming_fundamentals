// Dafny program q2.dfy compiled into C#
...
// Command-line arguments: build q2.dfy
// q2.dfy

method problem3(n: int)
...
namespace _module {
  ...
  public partial class __default {
    public static void problem3(BigInteger n, out BigInteger a, out BigInteger b, out BigInteger c)
    {
      a = BigInteger.Zero;
      b = BigInteger.Zero;
      c = BigInteger.Zero;
      if ((Dafny.Helpers.EuclideanModulus(n, new BigInteger(3))).Sign == 0) {
        a = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
        b = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
        c = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
      }
      if ((Dafny.Helpers.EuclideanModulus(n, new BigInteger(3))) == (BigInteger.One)) {
        a = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
        b = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
        c = (Dafny.Helpers.EuclideanDivision(n, new BigInteger(3))) + (BigInteger.One);
      }
      if ((Dafny.Helpers.EuclideanModulus(n, new BigInteger(3))) == (new BigInteger(2))) {
        a = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
        b = (Dafny.Helpers.EuclideanDivision(n, new BigInteger(3))) + (BigInteger.One);
        c = (Dafny.Helpers.EuclideanDivision(n, new BigInteger(3))) + (BigInteger.One);
      }
    }
  }
