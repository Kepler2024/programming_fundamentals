...
// Command-line arguments: build ex1.dfy
// ex1.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger exercise8(BigInteger y)
    {
      BigInteger z = BigInteger.Zero;
      if ((Dafny.Helpers.EuclideanModulus(y, new BigInteger(2))) == (BigInteger.One)) {
        z = Dafny.Helpers.EuclideanDivision((y) + (new BigInteger(3)), new BigInteger(2));
      } else {
        z = Dafny.Helpers.EuclideanDivision((new BigInteger(42)) - (y), new BigInteger(4));
      }
      return z;
    }
  }
